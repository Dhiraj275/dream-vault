const allTransactionTags = [
  { name: "Allowance", color: "#FFECB3" }, // Light Cream
  { name: "College Fees", color: "#FFCDD2" }, // Light Red
  { name: "Commute", color: "#D7CCC8" }, // Light Brown
  { name: "Education Materials", color: "#FFE082" }, // Light Amber
  { name: "Entertainment", color: "#FFF9C4" }, // Light Yellow
  { name: "Exclude", color: "#EF9A9A" }, // Soft Red
