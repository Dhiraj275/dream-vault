...
const CheckBox = ({ checked = false, onChange=()=>{}, className, label, onChangeText=()=>{}, index, link, editModeOn }: CheckBoxProps) => {
    return (
        <>
            ...
            >
                <View className='relative  ml-3'>
                    ...
                    <TextInput
                        ...
                        placeholder='Wish' placeholderTextColor={"#fffc"}>{label}</TextInput>
                </View>
            </TouchableOpacity>
        </>
    )
